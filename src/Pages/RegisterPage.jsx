...
import { RegsiterUser } from '../featurres/Auth/AuthSlice'
...
const RegisterPage = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const {name , phone , email , password , confirmPassword , agreeTerms} = formData
      ...
      const validate = () => {
        ...
        else if(formData.phone.length !== 10) tempErrors.phone = "Phone Number is invalid"
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link to="/">
          <img
            src="https://icon-library.com/images/2018/3782728_github-logo-github-png-hd-png-download.png"
            alt="GitHub Discover Logo"
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={handleChange}
                className={`h-4 w-4 ${
                  errors.agreeTerms ? 'text-red-600 border-red-300' : 'text-blue-600 border-gray-300'
